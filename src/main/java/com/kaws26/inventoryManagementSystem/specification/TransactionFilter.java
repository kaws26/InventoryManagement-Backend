package com.kaws26.inventoryManagementSystem.specification;
...
//used for filtering data in a database
public class TransactionFilter {

    public static Specification<Transaction> byFilter(String searchValue){
        return ((root, query, criteriaBuilder) -> {
            //if filter is null or empty then return all the transactions
